...
function HomePage() {
  useSeo({ title: "Team Bee Creative Studios — Best Wedding Photographer in Coimbatore, Tamil Nadu", description: "Premium wedding photography, candid storytelling and cinematic wedding films in Coimbatore, Tiruppur, Erode, Salem, Chennai & across Tamil Nadu. 45-day delivery, since 2017.", image: IMG.weddingGarland, canonical: "/" });
