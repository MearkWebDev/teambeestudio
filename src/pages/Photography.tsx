...
function PhotographyPage() {
  useSeo({ title: "Wedding Photography Coimbatore — Candid & Cinematic | Team Bee", description: "Wedding, pre-wedding, engagement, candid and maternity photography in Coimbatore. Cinematic frames, premium editing, 45-day delivery by Team Bee Creative Studios.", image: IMG.weddingGarland, canonical: "/photography" });
  return (
    <SiteLayout>
