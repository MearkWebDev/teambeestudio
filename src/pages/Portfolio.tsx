...
function PortfolioPage() {
  useSeo({ title: "Portfolio — Wedding Photography & Films | Team Bee Coimbatore", description: "Browse our wedding, pre-wedding, engagement, candid, maternity and destination wedding portfolio from across Tamil Nadu.", image: IMG.coupleBridge, canonical: "/portfolio" });
