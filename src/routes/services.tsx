...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      { title: "Wedding Photography & Film Services Coimbatore | Team Bee" },
      { name: "description", content: "Complete wedding photography, cinematic films, pre-wedding, engagement, candid, maternity and album services. Coimbatore · Tamil Nadu." },
      { property: "og:title", content: "Services — Team Bee Creative Studios" },
      { property: "og:description", content: "Every part of your celebration, covered with care and craft." },
