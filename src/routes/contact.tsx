...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — Book Wedding Photography in Coimbatore | Team Bee" },
      { name: "description", content: "Book Team Bee Creative Studios for wedding photography and cinematic films in Coimbatore. Call +91 98948 01912 or visit our R.S. Puram studio." },
      { property: "og:title", content: "Contact Team Bee Creative Studios" },
      { property: "og:description", content: "Reach our Coimbatore studio — let's create memories together." },
