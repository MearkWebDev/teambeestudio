...
export const Route = createFileRoute("/reviews")({
  head: () => ({
    meta: [
      { title: "Client Reviews — Team Bee Creative Studios Coimbatore" },
      { name: "description", content: "Hear from couples across Coimbatore and Tamil Nadu about their experience with Team Bee Creative Studios — wedding photographers since 2017." },
      { property: "og:title", content: "Reviews — Team Bee Creative Studios" },
      { property: "og:description", content: "Stories from couples we have been honoured to photograph." },
