...
export const Route = createFileRoute("/faq")({
  head: () => ({
    meta: [
      { title: "FAQ — Wedding Photography Coimbatore | Team Bee Creative Studios" },
      { name: "description", content: "Answers to the most common questions about wedding photography, cinematic films, pricing, delivery and destination shoots in Coimbatore." },
      { property: "og:title", content: "FAQ — Team Bee Creative Studios" },
      { property: "og:description", content: "Everything you need to know before booking your wedding photographer in Coimbatore." },
      { property: "og:image", content: IMG.bridePortrait },
