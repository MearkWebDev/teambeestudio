...
export const Route = createFileRoute("/films")({
  head: () => ({
    meta: [
      { title: "Cinematic Wedding Films Coimbatore | Team Bee Creative Studios" },
      { name: "description", content: "Cinematic wedding films, highlight reels and full event coverage in Coimbatore. Wedding films that bring sound, motion and emotion back to life." },
      { property: "og:title", content: "Cinematic Films — Team Bee" },
      { property: "og:description", content: "A photograph captures a moment. A film brings it back to life." },
